(function() {
  angular.module("officerspreparation").factory("TestService", function() {
    ...
    var test = [
      ...
      {
        question:
          "''אילו אירועים התרחשו בעקבות חקיקת חוק יסוד ''ירושלים בירת ישראל?",
        answers: [
          {
      ...
      {
        question:
          "אילו מקצועות מוגדים ''לימוד חובה'' עפ''י הגדרת הסוכנות היהודית במסמך הסטטוס קוו?",
        answers: [
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "כן, פקודותיו של צה''ל כפופות לעקרונות הדמוקרטיה ומחוייבות להיות שוויוניות",
            type: true
          },
          {
            answer:
              "כן, חיילי צה''ל זכאים לקבל את כל הזכויות המגיעות לאזרחים במדינת ישראל",
            type: false
          },
          {
            answer:
              "לא, צה''ל הוא מסגרת היררכית הפועלת על פי עקורונות שאינם כפופים לעקרונות הדמוקרטיה",
            type: false
          },
          {
            answer:
              "לא, צה''ל הוא מסגרת נפרדת שלא כפופה לשום גורם ולכן חוקי הדמוקרטיה המדיניים אינם חלים בו",
            type: false
          }
        ]
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "כן, פרט ליהודים המגדירים עצמם אתאיסטים, או ליהודים ניצולי שואה",
            type: false
          },
          {
            answer:
              "לא, פרט ליהודים המגדירים עצמם אתאיסטים, או ליהודים ניצולי שואה",
            type: false
          },
          {
      ...
      {
        question:
          "מבין האפשרויות הבאות, מה נחשבת לסוגיה מרכזית בדמוקרטיה הישראלית?",
        answers: [
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "שיוויון בפני החוק, פומביות, הזכות להליך הוגן ושקיפות המשפט",
            type: true
          },
          {
            answer:
              "שיוויון בפני החוק, הזכות להליך הוגן ושקיפות המשפט, ערך חיי אדם",
            type: false
          },
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "מערכת הנישואין והגירושין, ניהול מערכת הכשרות ותחזוק מתקנים דתיים",
            type: true
          },
          {
            answer:
              "ניהול מערכת הכשרות, שיפוט על פי עקרונות ההלכה ומערכת הנישואין והגירושין",
            type: false
          },
          {
            answer:
              "שיפוט על פי עקרונות ההלכה, ניהול מערכת הכשרות ותחזוק מתקנים דתיים",
            type: false
          },
          {
            answer:
              "תחזוק מתקנים דתיים, שיפוט על פי עקרונות ההלכה ומערכת הנישואין והגירושין",
            type: false
          }
        ]
      },
      ...
      {
        question:
          "היא התפילה הפותחת את יום הכיפור, _____ היא התפילה המסיימת אותו,____?",
        answers: [
          {
      ...
      {
        question:
          "באיזו שנה נקבע בחוק שיום הזיכרון לחללי מערכות ישראל יחול סמוך ליום העצמאות?",
        answers: [
          {
            answer: "1963",
            type: true
      ...
      {
        question:
          " _____יום הזיכרון הממלכתי לבנימין זאב הרצל ז''ל חל בתאריך ____, ביום זה מציינים את?",
        answers: [
          {
      ...
      {
        question:
          " __________ יום השואה הבינלואמי חל בתאריך ______ מכיוון שביום זה?",
        answers: [
          {
      ...
      {
        question:
          "_____כל יום במהלך צום הרמדאן מתחיל בארוחת ה-____ ומסתיים בארוחת ה?",
        answers: [
          {
            answer: "צחור, אפטאר",
            type: true
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "הדרוזים מאמינים ש''אלחכם'' היה נביא אמת ואילו המוסלמים מאמינים שמוחמד היה הנביא האחרון, ומתקופתו האמונה בנביא הייתה כפירה",
            type: true
          },
          {
          ...
          {
            answer:
              "הדרוזים מאמינים בדתם וחיים לפי תרבותם בעוד שהמוסלמים נאמנים לאדמתם ולמדינה בה הם חיים",
            type: false
          },
          {
            answer:
              "''הדרוזים מאמינים בפרקים מסוימים בקוראן שנכתבו ב''אל מדינה'' לעומת המוסלמים שמאמינים בכול פרקי הקוראן- אלו שנכתבו ב''אל מדינה'' ואילו שנכתבו ב''מכה",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "התורה שבכתב מתארת באופן תמציתי, ואילו התורה שבעל פה מפרטת מתארת ומרחיבה",
            type: true
          },
          {
            answer:
              "התורה שבכתב עוברת בכתב ואילו התורה שבעל פה עוברת מדור לדור מפה לאוזן",
            type: false
          },
          {
            answer:
              "התורה שבכתב מכילה את כלל התנ''ך ואילו התורה שבעל פה מכילה פרטים כלליים, חוקים, מצוות והלכות",
            type: false
          },
          {
            answer:
              "התורה שבכב הועברה מה' במעמד הר סיני למשה ועמו, ואילו התורה שבעל פה הועברה בתקופה מוקדמת יותר",
            type: false
          }
        ]
      },
      ...
      {
        question:
          "איזו משפחה הנהיגה את המרד שפרץ נגד השלטון ההלניסטי בשנת 167 לפנה''ס?",
        answers: [
          {
            answer: "חשמונאי",
            type: true
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "סיוע ליהודים קשיי יום כלכלית, חלוקת מזון ומציאת מקומות עבודה",
            type: false
          }
        ]
      },
      {
        question:
          "..לפי העלילת הדם האנטישמית המוכרת, היהודים משתמשים בדם ילדים נוצרים על מנת?",
        answers: [
          {
      ...
      {
        question:
          "מה נאלצו יהודי תימן לעשות בעקבות רדיפה דתית בשנים 1678-1679?",
        answers: [
          {
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "עליית היהודים לארץ ישראל לאחר עלילות הדם של זקני ציון בספרד",
            type: false
          },
          {
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "פוגרום בקישינב, בו נרצחו יהודי ודמם נשפך לנהל כסמל לרדיפת יהודים",
            type: false
          },
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "משפט בו הואשמו 14 פעילים בניהם יהודים בריגול לטובת ישראל וארה''ב",
            type: true
          },
          {
          ...
          {
            answer:
              "משפטים כנגד יהודים אשר קיימו אורח חיים דתי במהלך שירותם הצבאי",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "''הלוחם שעודד את המתבצרים במצדה לבחור ''בחירות על פני חיים''",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "יהודים אשר השתלבו בתרבות ובחברה הסובבת ודברו ערבית, לפני המהאה ה15",
            type: true
          },
          {
      ...
      {
        question:
          "נאמר על רש''י: ''פיזר את אוצרות רוחו... כנהר הנותן מימיו לכל, בלי לדעת שאין עולם בלעדיהם''. מדוע?",
        answers: [
          {
      ...
      {
        question:
          "רבי יהודה הנשיא, מנהיג בקהילה היהודית, עסק בתחומים רבים. מה היה עיסוקו המרכזי?",
        answers: [
          {
            answer: "חיבור משנה",
            type: true
      ...
      {
        question:
          "בשנת 1938, אילו שמות אולצו היהודים להוסיף לתעודת הזהות שלהם?",
        answers: [
          {
      ...
      {
        question:
          "כיצד טופלו הפליטים היהודים מיד לאחר מלחמת העולם השנייה  ע''י בעלות הברית?",
        answers: [
          {
      ...
      {
        question:
          "כיצד מכונה התקופה שלאחר מלחמת העולם הראשונה בהיסטוריה הגרמנית?",
        answers: [
          {
      ...
      {
        question:
          "כיצד נקראו היחידות אשר היו אמונות על טיהור הגזע במהלך הקרבות בברית המועצות?",
        answers: [
          {
            answer: "אייזנצגרופן",
            type: true
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "הסכם שנחתם בין ממשלת מערב גרמניה לממשלת ישראל הכולל 3 מיליארד מארק ",
            type: true
          },
          {
            answer:
              "הסכם לפיו מדינת ישראל צריכה לסייע כלכלית לניצולי שואה עד יום מותם מכספי המדינה",
            type: false
          },
          {
            answer:
              "הסכם לפיו הצלב האדום שילם מיליארד מארק לשלטון הנאצי עבור הצלתם של 3,000 יהודים",
            type: false
          },
          {
            answer:
              "הסכם בין האו''ם למדינת ישראל לפיו ישראל תקבל מליון דולר כפיצוי לפשעי הנאצים וחטאיהם",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "מושג אותו תבע בן גוריון שמשמעו, כי גרמניה של היום איננה גרמניה הנאצית",
            type: true
          },
          {
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "  כ3 מיליאד המארק מגואלים בדם אחינו, איננו מוכנים לגעת בהם ",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "אוניית מעפילים שיצאה מגרמנייה אל עבר קובה אך הממשלה שם סירבה לקבל אותה, בשנת 1939",
            type: true
          },
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "עסקן גרמני שניצל את מעמדו החברתי להצלת אלפי יהודים באמצעות מפעל לייצור סירים ופגזים",
            type: true
          },
          {
            answer:
              "יהודי גרמני שניצל את היותו בכיר ב''וועד להצלה'' והציל רבבות יהודים בהברחתם לשוויץ",
            type: false
          },
          {
            answer:
              "איש עסקים לדיפלומט שוודי שפעל בהונגריה תוך שימוש במעמדו להצלת יהודי הונגריה",
            type: false
          },
          {
            answer:
              "תושב אמסטרדם אשר הסתיר יהודים, בין היתר הסתיר את אנה פרנק ומשפחתה",
            type: false
          }
        ]
      },
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "''התובע הכללי במשפט אייכמן שתבע את השמפט ''6 מליון קטגוריות",
            type: false
          },
          {
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "קונסול יפני שניצל את מעמדו להבריח רבבות יהודים מהעיר קובנה שבליטא",
            type: true
          },
          {
            answer:
              "קונסול סין שניפק אשרות ליהודי אוסטריה וע''י כך הבריח אותם מאירופה",
            type: false
          },
          {
            answer:
              "(מפקד חיל האוויר היפני שפיקד על מבצע פרל הארבור (הפצצת חיל הים האמריקאי",
            type: false
          },
          {
            answer:
              "שר החוץ הסיני אשר חתם על הסכמי הברית בין גרמניה הנאצית לקיסרות סין",
            type: false
          }
        ]
      },
      ...
      {
        question:
          "איזו מהחברות הבאות היא חברה צודקת ושוויונית המתבססת על עקרונות סוציאליסטיים?",
        answers: [
          {
            answer: "קיבוץ",
            type: true
      ...
      },
      {
        ...
        answers: [
          {
            answer:
              "הברון רוטשילד השקעי המושבות סכומים גדולים ושלח צוותים של מומחים ופקידים שיסייעו בניהולם הכלכלי",
            type: true
          },
          {
            answer:
      ...
      {
        question:
          "כיצד נקראה השכונה היהודית הראשונה שהוקמה מחוץ לחומות ירושלים?",
        answers: [
          {
            answer: "משכנות שאננים",
            type: true
      ...
      {
        question:
          "כמה עולים בעליה הראשונה דגלו בעבודת אדמה והקימו מושבות חדשות?",
        answers: [
          {
            answer: "5000",
            type: true
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "הכרה רשמית בתביעותיה של תנועת ההסתדרות הכללית על ארץ ישראל",
            type: false
          },
          {
      ...
      {
        question:
          "''מהי השיטה בה נקט הברון רוטשילד שהפכה את העולים ל''מנהלי עבודה?",
        answers: [
          {
            answer: "הפקידות",
            type: true
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer:
              "תוכניות אשר מטרתן הייתה להעלות עולים בצורה בלתי לגאלית בזמן מלחמת העולם השנייה",
            type: false
          },
          {
            answer:
              "תוכנית אשר מטרתן הייתה רקימת קשר עם ארה''ב בזמן מלחמת העולם השנייה",
            type: false
          },
          {
            answer:
              "תוכניות אשר מטרתן הייתה להציל יהודים מרוסיה ואתיופיה בזמן מלחמת העולם השנייה",
            type: false
          }
        ]
      },
      ...
      {
        question:
          "על שמו של איזה רמטכ''ל נקרא בסיס מטה מפקדת זרוע היבשה בקרית מלאכי?",
        answers: [
          {
            answer: "חיים בר לב ",
            type: true
      ...
      {
        question:
          "איזה נשיא נולד בשנת 1884 בפולטובה שברוסיה ונקבר בהר המנוחות בירושלים?",
        answers: [
          {
            answer: "יצחק בן צבי",
            type: true
      ...
      {
        question: "באיזה כפר ערבי התגורר משה שרת?",
        answers: [
          {
            answer: "עין סיניה",
            type: true
      ...
      {
        question: "באיזה שנה הכירה ישראל בארגון אש''ף?",
        answers: [
          {
            answer: "1993",
            type: true
      ...
      {
        question: "באיזה שנה הצטרף דוד אלעזר לפלמ''ח?",
        answers: [
          {
            answer: "1946",
            type: true
      ...
      {
        question: "באיזה שנים התקיימה העלאת יהודי תימן?",
        answers: [
          {
            answer: "1948-1950",
            type: true
      ...
      {
        question: "באיזה תאריך היה הטבח בכפר קאסם?",
        answers: [
          {
            answer: "ב29 באוקטובר 1956",
            type: true
          },
          {
            answer: "ב15 ביולי 1967",
            type: false
          },
          {
            answer: "ב29 בינואר 1976",
            type: false
          },
          {
            answer: "ב15 בפברואר 1956",
            type: false
          }
        ]
      },
      {
        question: "באיזה תאריך נחטפו שלושת הנערים גיל-עד, נפטלי ואייל?",
        answers: [
          {
            answer: "12.06.2014",
            type: true
      ...
      {
        question: "באיזה תאריך נפטר משה שרת ז''ל?",
        answers: [
          {
            answer: "1965",
            type: true
      ...
      {
        question: "באיזה תאריך נרצח יצחק רבין ז''ל?",
        answers: [
          {
            answer: "ב4 בנובמבר 1995",
            type: true
          },
          {
            answer: "ב14 בנובמבר 1994",
            type: false
          },
          {
            answer: "ב14 באוקטובר 1995",
            type: false
          },
          {
            answer: "ב4 באוקטובר 1994",
            type: false
          }
        ]
      },
      {
        question: "באיזה תפקיד כיהן זלמן שזר בממשלת ישראל הראשונה?",
        answers: [
          {
            answer: "שר החינוך",
            type: true
      ...
      {
        question: "באיזו עיר פרצו אירועי ''ואדי סאליב''. בחר בעיר המתאימה",
        answers: [
          {
            answer: "חיפה",
            type: true
      ...
      {
        question: "באיזו שנה ובאיזה חודש החל גדי אייזנקוט לכהן כרמטכ''ל?",
        answers: [
          {
            answer: "פברואר 2015",
            type: true
      ...
      {
        question: "באיזו שנה כונסה וועידת מדריד?",
        answers: [
          {
            answer: "1991",
            type: true
      ...
      {
        question: "באלו שנים התקיים משטר הצנע ומה משמעותו?",
        answers: [
          {
            answer:
              "ב1949-1952. משמעותו - קיצוב ופיקוח על קניית מוצרי יסוד ועל מחיריהם",
            type: true
          },
          {
            answer:
              "ב1947-1950. משמעותו - קיצוב ופיקוח על קניית מוצרי יסוד ועל מחיריהם",
            type: false
          },
          {
            answer:
              "ב1949-1952. משמעותו - הגברת קצב יצור מוצרים בסיסיים ומכירתם לארצות אחרות לצורכי מסחר",
            type: false
          },
          {
            answer:
              "ב1944-1947. משמעותו - הגברת קצב יצור מוצרים בסיסיים ומכירתם לארצות אחרות לצורכי מסחר",
            type: false
          }
        ]
      },
      {
        question:
          "בהמלך אילו שנים ניהלה ברית המועצות מדיניות של אפליה קשה ופגיעה ביהודי המדינה?",
        answers: [
          {
            answer: "שנות החמישים והשישים",
            type: true
          },
          {
            answer: "שנות העשרים והשלושים",
            type: false
          },
          {
            answer: "שנות הארבעים והחמישים",
            type: false
          },
          {
            answer: "שנות השמונים והתשעים",
            type: false
          }
        ]
      },
      {
        question: "בין אילו שנים כיהן יצחק רבין כרמטכ''ל?",
        answers: [
          {
            answer: "1968-1964",
            type: true
      ...
      {
        question: "במה אופיינה כהונתו של אולמרט?",
        answers: [
          {
            answer: "החרפת הסכסוך ברצועת עזה",
            type: true
          },
          {
            answer: "החרפת הסכסוך היהודי-ערבי",
            type: false
          },
          {
            answer: "החרפת הלחימה הטכנולוגית",
            type: false
          },
          {
            answer: "החרפה במצב המשק הישראלי",
            type: false
          }
        ]
      },
      {
        question: "במהלך ''מבצע יכין'' כמה עולים עלו לארץ?",
        answers: [
          {
            answer: "כ-80 אלף עולים",
            type: true
          },
          {
            answer: "כ-70 אלף עולים",
            type: false
          },
          {
            answer: "כ-50 אלף עולים",
            type: false
          },
          {
            answer: "כ-30 אלף עולים",
            type: false
          }
        ]
      },
      {
        question: "במהלך איזה מלחמה תפקודו של שרון היה שנוי במחלוקת?",
        answers: [
          {
            answer: "מלחמת שלום הגליל",
            type: true
          },
          {
            answer: "מלחמת לבנון השניה",
            type: false
          },
          {
            answer: "מלחמת העצמאות",
          ...
          {
            answer: "מלחמת כיפורים",
            type: false
          }
        ]
      },
      {
        question: "במסגרת איזו מפלגה פעלה גולדה מאיר?",
        answers: [
          {
            answer: "פועלי ציון",
            type: true
      ...
      {
        question:
          "בעקבות איזו ועדה פרצו אירועי ''גאות ושפל''? (האינתיפאדה השניה)",
        answers: [
          {
            answer: "ועידת קמפ דיויד",
            type: true
          },
          {
            answer: "ועידת קמפ דן",
      ...
      {
        question: "בראש איזו מפלגה עמד דוד בן גוריון?",
        answers: [
          {
            answer: "מפלגת פועלי ארץ ישראל",
            type: true
          },
          {
            answer: "מפלגת פועלי ציון",
            type: false
          },
          {
            answer: "מפלגת אחדות העבודה",
            type: false
          },
          {
            answer: "מפלגת העולים",
      ...
      {
        question: "היכן למד יצחק שמיר?",
        answers: [
          {
            answer: "גימנסיה העברית בירושלים",
            type: true
          },
          {
            answer: "באוניברסיטה הפתוחה בפולין",
            type: false
          },
          {
            answer: "במכללה לרפואה בצרפת",
            type: false
          },
          {
            answer: "באוניברסיטה הטכנולוגית באורטוב",
            type: false
          }
        ]
      },
      {
        question: "היכן שוכנו באופן זמני עולי העלייה של ''מבצע יכין?''",
        answers: [
          {
            answer: "במחנות העקורים",
            type: true
          },
          {
            answer: "בבקתות עץ",
          ...
          {
            answer: "במחנות ריכוז לשעבר",
            type: false
          }
        ]
      },
      {
        question: "כיצד כונו המבצעים של עליית יהודי איתיופיה?",
        answers: [
          {
            answer: "מבצע שלמה, מבצע משה",
            type: true
          },
          {
            answer: "מבצע זכריה, מבצע עמוד ענן",
            type: false
          },
          {
            answer: "מבצע מרבד הקסמים, מבצע זכריה",
            type: false
          },
          {
            answer: "מבצע דוד, מבצע עופרת יצוקה",
            type: false
          }
        ]
      },
      {
        question: "כיצד מכונים יהודים מזרע ביתא ישראל מאיתיופה?",
        answers: [
          {
            answer: "פלאשמורה",
            type: true
      ...
      {
        question: "כמה זמן שירת מרדכי מקלף כרמטכ''ל?",
        answers: [
          {
            answer: "שנה",
            type: true
      ...
      {
        question: "כמה יהודים עלו מברית המועצות?",
        answers: [
          {
            answer: "500,000",
            type: true
      ...
      {
        question: "כמה ימים נמשכה הלחימה בעזה בעת מבצע ''צוק איתן?''",
        answers: [
          {
            answer: "50",
            type: true
      ...
      {
        question:
          "לאחר איזה רצח החל לעבוד משה שרת במחלקה המדינית של הסוכנות היהודית?",
        answers: [
          {
            answer: "אורלוזורוב",
            type: true
      ...
      {
        question: "לאחר שהתפטר בן גוריון מראשות הממשלה היכן קבע את ביתו?",
        answers: [
          {
            answer: "שדה בוקר",
            type: true
      ...
      {
        question: "לאחר שלוי אשכול וויתר על תפקיד שר הבטחון, למי ניתן התפקיד?",
        answers: [
          {
            answer: "משה דיין",
            type: true
      ...
      {
        question: "לאיזה פיקוד מונה גדי אייזנקוט בשנת 2006 כאלוף?",
        answers: [
          {
            answer: "אלוף פיקוד צפון",
            type: true
          },
          {
            answer: "אלוף פיקוד דרום",
            type: false
          },
          {
            answer: "אלוף פיקוד מרכז",
            type: false
          },
          {
            answer: "אלוף מז''י",
      ...
      {
        question: "לאיזה שר מונה אריאל שרון בממשלת בגין?",
        answers: [
          {
            answer: "שר החקלאות",
            type: true
      ...
      {
        question: "לאילו תפקידים התמנה צבי צור במלחמת העצמאות?",
        answers: [
          {
            answer: "צירוף לחטיבת גבעתי, פיקוד על גדוד 54",
            type: true
          },
          {
            answer: "פיקוד על חיל שיריון, התמנה לנציב קבילות החיילים",
            type: false
          },
          {
            answer: "פיקוד על גדוד 52, צירוף לחטיבת גבעתי",
            type: false
          },
          {
            answer: "צירוף לחטיבה 10, פיקוד על גדוד 106",
            type: false
          }
        ]
      },
      {
        question: "למטרת מה נלחמו אסירי ציון?",
        answers: [
          {
            answer: "לאפשר עלייה חופשית של יהודי ברית המועצות לישראל",
            type: true
          },
          {
            answer: "לאפשר עליית יהודים מכל רחבי העולם",
            type: false
          },
          {
            answer: "לאפשר רגיעה מהגזרות הקשות שהיו עליהם",
            type: false
          },
          {
            answer: "לאפשר מדינה יהודית ועצמאית",
            type: false
          }
        ]
      },
      {
        question: "מדוע מתפטר רבין בדצמבר 1975?",
        answers: [
          {
            answer: "משבר פוליטי",
            type: true
          ...
          {
            answer: "פרידה מבת זוגתו",
            type: false
          },
          {
            answer: "תאונה קשה שעבר",
            type: false
          },
          {
            answer: "מות בן משפחה",
      ...
      {
        question:
          "מדוע תוקן חוק השבות בשנת 1970 ונקבעה בו ההגדרה ההלכתית המחייבת למונח ''יהודי?''",
        answers: [
          {
            answer: "בעקבות העתירה לבג''ץ של רב סרן בנימין שליט",
            type: true
          },
          {
            answer: "בעקבות העתירה לבג''ץ של השופט חיים כהן",
            type: false
          },
          {
            answer: "בשל בקשתו של הציבור היהודי דתי",
            type: false
          },
          {
            answer: "בשל בקשתו של אלעזר דון יחיא שחקר את הפרשה",
            type: false
          }
        ]
      },
      {
        question: "מה הוחלט מ-1992?",
        answers: [
          {
            answer: "כל מי שאימו יהודייה יוכל לעלות לא''י",
            type: true
          },
          {
            answer: "כל מי שאביו יהודי יכול לעלות לא''י",
            type: false
          },
          {
            answer: "כל מי שרוצה לעלות לא''י יכול",
            type: false
          },
          {
            answer: "כל מי שהוא דור רביעי ליהודייה או יהודי יוכל לעלות לא''י",
            type: false
          }
        ]
      },
      {
        question: "מה החליט שמיר במלחמת המפרץ?",
        answers: [
          {
            answer: "להיענות לבקשת ארב''ה ולהימנע מתגובה צבאית לעיראק",
            type: true
          },
          {
            answer: "לא להסכים לבקשת ארב''ה ולהגיב צבאית לעירק",
            type: false
          },
          {
            answer: "לברוח מהחלקים שעירק פוצצה לישראל",
            type: false
          },
          {
            answer: "להתיישב בחלקי הארץ שעירק הפגיזה ולא לזוז",
            type: false
          }
        ]
      },
      {
        question: "מה היה הכינוי של אוסוולד רופאייזן?",
        answers: [
          {
            answer: "האח דניאל",
            type: true
      ...
      {
        question: "מה היו המעברות?",
        answers: [
          {
            answer:
              "שיכונים זמניים של צריפים, פחונים ואוהלים שהוקמו בשולי הערים",
            type: true
          },
          {
            answer: "קבוצה קטנה של הקהילה האתיופית שהגיעו לארץ",
            type: false
          },
          {
            answer: "קרוואנים שמוקמו בשולי הערים והמושבות",
            type: false
          },
          {
            answer: "בוצה של יהודי מרוקו שהגיעו לארץ ממחנות העקורים",
            type: false
          }
        ]
      },
      {
        question: "מה העיקרון הגדול שהכריז עליו דוד בן גוריון בהקמת המדינה?",
        answers: [
          {
            answer: "ממלכתיות",
            type: true
      ...
      {
        question: "מה ייסד בגין עם הקמת המדינה?",
        answers: [
          {
            answer: "תנועת החירות",
            type: true
      ...
      {
        question: "מה משטר הצנע לא הצליח למנוע?",
        answers: [
          {
            answer: "היווצרותם של פערים חברתיים-כלכליים לאורך זמן",
            type: true
          },
          {
            answer: "היווצרותם של פערים ביטחוניים לאורך זמן",
            type: false
          },
          {
            answer: "היווצרותם של פערים השכלתיים לאורך זמן",
            type: false
          },
          {
            answer: "היווצרותם של פערים חברתיים לאורך זמן",
            type: false
          }
        ]
      },
      {
        question: "מה משמעותו של משטר הצנע?",
        answers: [
          {
            answer: "קיצוב ופיקוח על קניית מוצרי יסוד ועל מחיריהם",
            type: true
          },
          {
            answer: "קיצוב ופיקוח על התחום החקלאי ועל חלוקתו",
            type: false
          },
          {
            answer: "קיצוב ופיקוח על כל נושאי הילודה במשפחה",
            type: false
          },
          {
            answer: "קיצוב ופיקוח על כל נושאי הביגוד ומחיריהם בארץ",
            type: false
          }
        ]
      },
      {
        question: "מה עיצבה גולדה מאיר כשרת עבודה?",
        answers: [
          {
            answer: "זכויות העובד בסיסיות, שוק העבודה ישראלי",
            type: true
          },
          {
            answer: "מעברות, הקמת בתי זיקוק",
            type: false
          },
          {
            answer: "מעבדות, הקמת מפעלי ים המלח",
            type: false
          },
          {
            answer: "הבורסה הישראלית, זכויות המעביד",
            type: false
          }
        ]
      },
      {
        question: "מה קבע יגאל ידין?",
        answers: [
          {
            answer: "הכללים היסודיים על פיהם מתנהל צהל בתחומי הגיוס והמבנה",
            type: true
          },
          {
            answer: "הסכם ג'נבה בו נאסר לקיחת שבויים במלחמה",
            type: false
          },
          {
            answer: "את פיזור הבסיס ואת חוק המידור",
            type: false
          },
          {
            answer: "את סיכום המשכורת החודשית אשר מגיעה לחייל",
            type: false
          }
        ]
      },
      {
        question: "מה קובע חוק ''נכסי נפקדים?''",
        answers: [
          {
            answer: "קובע כי אדמותיו של אדם שעזב למדינות אויב יופקעו ממנו",
            type: true
          },
          {
            answer: "קובע כי אדמותיו של אדם שעזב את הארץ ל-10 שנים יופקע ממנו",
            type: false
          },
          {
            answer: "קובע כי אדם המחזיק באדמה מעל 10 שנים הופכת לאדמותיו",
            type: false
          },
          {
            answer:
              "קובע כי כל אדם המחזיק בשטח גדול של אדמה מחויב להעביר חצי ממנו למדינה",
            type: false
          }
        ]
      },
      {
        question:
          "מה שמה של המחאה אשר חידדה את הפערים החברתיים והכלכליים של המדינה?",
        answers: [
          {
            answer: "הפנתרים השחורים",
            type: true
          ...
          {
            answer: "האריות השחורים",
            type: false
          },
          {
            answer: "הפנתרים הלבנים",
            type: false
          }
        ]
      },
      {
        question: "מהו ''מבצע שלמה?''",
        answers: [
          {
            answer: "מבצע הטסה גלוי במהלכו עלו לארץ 14000 יהודיים",
            type: true
          },
          {
            answer: "מבצע הטסה סמוי במהלכו עלו לארץ 24000 יהודיים",
            type: false
          },
          {
            answer: "עליית יהודי תימן במהלכו עלו לארץ 14000 יהודיים",
            type: false
          },
          {
            answer: "עליית יהודי סודן במהלכו עלו לארץ 24000 יהודיים",
            type: false
          }
        ]
      },
      {
        question: "מהו אחד הפתרונות המרכזיים שמצא לוי אשכול לקליטת העליות?",
        answers: [
          {
            answer: "הקמת מעברות",
            type: true
      ...
      {
        question: "מהו מבצע ''מרבד הקסמים?''",
        answers: [
          {
            answer: "העלאת יהודי תימן",
            type: true
          },
          {
            answer: "העלאת יהודי עיראק",
            type: false
          },
          {
            answer: "העלאת יהודי רוסיה",
            type: false
          },
          {
            answer: "העלאת יהודי מרוקו",
            type: false
          }
        ]
      },
      {
        question: "מהו מצבע ''יכין?''",
        answers: [
          {
            answer: "העלאת יהודי מרוקו",
            type: true
          ...
          {
            answer: "העלאת יהודי אירופה",
            type: false
          }
        ]
      },
      {
        question: "מהו מבצע ''ענבי זעם?''",
        answers: [
          {
      ...
      {
        question: "מהו עקרון הממלכתיות?",
        answers: [
          {
            answer: "פירוקם של מוסדות מפלגתיים ובניית מוסדות מדינה חזקים",
            type: true
          },
          {
            answer: "פירוק גופים שמפריעים בהקמתם של מוסדות מפלגתיים",
            type: false
          },
          {
            answer: "פירוק מוסדות המדינה והקמת גופים שיסייעו בהקמת המדינה",
            type: false
          },
          {
            answer: "בניית מוסדות מפלגתיים שיחלפו את מוסדות המדינה",
            type: false
          }
        ]
      },
      {
        ...
        answers: [
          {
            answer: "תנועה פוליטית ישראלית שדוגלת בקומוניזם",
            type: true
          },
          {
            answer: "מפלגה שהתקיימה בין השנים 1961-1988",
            type: false
          },
          {
            answer: "מפלגת הציוניים הכללים",
            type: false
          },
          {
            answer: "מפלגת הפועלים המאוחדת",
            type: false
          }
        ]
      },
      {
        question: "מהי מטרתה של ''וועדת מדריד?''",
        answers: [
          {
            answer:
              "השגת שלום במזרח התיכון בין ישראל לשכנותיה - ירדן, סוריה ,לבנון והפלסטינאים",
            type: true
          },
          {
            answer: "פתרון הסכסון ערבי -יהודי",
            type: false
          },
          {
            answer:
              "וועדה בחסות הקהילה הערבית, מטרתה להשגת שלום במזרח התיכון לאחר האינתיפאדה השנייה",
            type: false
          },
          {
            answer: "השגת שלום במזרח התיכון בין ישראל מצריים וסוריה",
            type: false
          }
        ]
      },
      {
        question: "מהי תכנית ההתנתקות?",
        answers: [
          {
            answer: "נסיגה חד צדדית מרצועת עזה וצפון השומרון",
            type: true
          },
          {
            answer: "תכנית שמטרתה לנתק את עזה משטח ישראל",
            type: false
          },
          {
            answer: "נסיגה דו צדדים מרצועת עזה וצפון השומרון",
            type: false
          },
          {
            answer: "בניית גדר הפרדה בין סוריה וישראל",
            type: false
          }
        ]
      },
      {
        question: "מי היה הנשיא בעת מלחמת יום הכיפורים?",
        answers: [
          {
            answer: "אפרים קציר",
            type: true
      ...
      {
        question: "מי הייתה רינת שפירא?",
        answers: [
          {
            answer: "מורה צברית שלימדה במספר מעברות",
            type: true
          },
          {
            answer: "מורה צברית שלימדה במוסדות לא יהודיים",
            type: false
          },
          {
            answer: "חוקרת העוסקת במדע המדינה",
            type: false
          },
          {
            answer: "פרופסור באוניברסיטת בן גוריון בנגב",
            type: false
          }
        ]
      },
      {
        question: "מי הקים את פלוגת הג'יפים (שועלי שמשון)?",
        answers: [
          {
            answer: "צבי צור",
            type: true
      ...
      {
        question: "מי כהן כראש הרשות המקומית בקרית מלאכי?",
        answers: [
          {
            answer: "משה קצב",
            type: true
      ...
      {
        question: "מי מבין האנשים הנ''ל חתמו על הסכמי אוסלו?",
        answers: [
          {
            answer: "יאסר ערפאת, יצחק רבין",
            type: true
          },
          {
            answer: "מנחם בגין, גולדה מאיר",
            type: false
          },
          {
            answer: "דוד בין גוריון, מלך ירדן",
            type: false
          },
          {
            answer: "מנחם בגין, יאסר ערפאת",
            type: false
          }
        ]
      },
      {
        question: "מתי מונה יעקב דורי למפקד ההגנה?",
        answers: [
          {
            answer: "מאורעות תרפ''ט",
            type: true
          },
          {
            answer: "בעלייה השלישית",
            type: false
          },
          {
            answer: "רצח ארלוזורוב",
            type: false
          },
          {
            answer: "בעלייה החמישית",
            type: false
          }
        ]
      },
      {
        question: "על איזה הסכם חתם בנימין נתניהו?",
        answers: [
          {
            answer: "וואי",
            type: true
      ...
      {
        question: "על איזה יחידה פיקד משה (בוגי) יעלון במהלך מבצע ליטאני?",
        answers: [
          {
            answer: "סיירת צנחנים",
            type: true
          ...
          {
            answer: "מפקד גדוד גולני",
            type: false
          }
        ]
      },
      {
        question: "על מה הוענק לאמנון ליפקין שחק עיטור עוז בפעם השנייה?",
        answers: [
          {
            answer: "על תפקודו במבצע '' אביב נעורים''",
            type: true
          },
          {
            answer: "על תפקודו כמפקד שייטת 13",
            type: false
          },
          {
            answer: "על תפקודו כמפקד סיירת ''דוכיפת''",
            type: false
          },
          {
            answer: "על תפקודו כסגן מפקד חטיבת צנחנים",
            type: false
          }
        ]
      },
      {
        question:
          "על שמו של איזה רמטכ’‘ל נקרא בסיס הטסה וההכשרות המיוחדות (מרהו’‘ם) בתל נוף?",
        answers: [
          {
            answer: "משה לוי",
            type: true
      ...
      },
      {
        ...
        answers: [
          ...
          {
            answer: "מצודה מ''מצודות הטיגריט''",
            type: false
          },
          {
            answer: "שמו השני של מלך ירדן",
            type: false
          },
          {
            answer: "מנהיג הערבי ארץ ישראל בזמן מאורעות תר''פ",
            type: false
          }
        ]
      },
      {
        question: "''אלטלנה'' היא ספינת...?",
        answers: [
          {
            answer: "נשק של האצ''ל",
            type: true
          ...
          {
            answer: "נשק של הפלמ''ח",
            type: false
          },
          {
            answer: "מעפילים, שנתפסה ע''י הבריטים",
            type: false
          },
          {
            answer: "מעפילים ראשונה, שהגיעה לארץ ישראל",
            type: false
          }
        ]
      },
      {
        question: "איזה הסכם נחתם בסוף מלחמת העצמאות?",
        answers: [
          {
            answer: "הסכם רודוס",
            type: true
      ...
      {
        question:
          "איזה ארגון התפתח בצורה משמעותית בעקבות מאורעות תרפ''ט(1929)?",
        answers: [
          {
            answer: "הגנה",
            type: true
      ...
      {
        question: "איזה ארגון קם עקב פיזור ארגון השומר?",
        answers: [
          {
            answer: "ההגנה",
            type: true
      ...
      {
        question: "איזה מבצע נחשב למבצע הראשון שבוצע לפי עקרונות תוכנית ד'?",
        answers: [
          {
            answer: "מבצע נחשון",
            type: true
      ...
      {
        question: "איזו וועדה הוקמה בעקבות תוצאות מלחמת שלום הגליל?",
        answers: [
          {
            answer: "ועדת כהן",
            type: true
      ...
      {
        question: "איזו וועדה חקרה את תוצאות מלחמת יום הכיפורים?",
        answers: [
          {
            answer: "וועדת אגרנט",
            type: true
      ...
      {
        question: "איזו וועדה מונתה בכדי לחקור את תוצאות מלחמת לבנון השנייה?",
        answers: [
          {
            answer: "ועדת וינוגרד",
            type: true
      ...
      {
        question: "איזו ועדה התכנסה בתאריך ה-1 בספטמבר 1967?",
        answers: [
          {
            answer: "וועדת חרטום",
            type: true
          ...
          {
            answer: "וועדת וינוגרד",
            type: false
          }
        ]
      },
      {
        question: "איזו עיר נכבשה ב''מבצע חמץ'' במסגרת מלחמת העצמאות?",
        answers: [
          {
            answer: "יפו",
            type: true
      ...
      {
        question: "ב29 למרץ 2002 צה''ל יצא למבצע...?",
        answers: [
          {
            answer: "חומת מגן",
            type: true
      ...
      {
        question: "באיזה שנה החלה ישראל בהקמתה של גדר ההפרדה?",
        answers: [
          {
            answer: "2003",
            type: true
      ...
      {
        question: "באיזו שנה הוקם הפלמ''ח?",
        answers: [
          {
            answer: "1941",
            type: true
      ...
      {
        question: "באיזו שנה הוקמה יחידה 101?'",
        answers: [
          {
            answer: "1953",
            type: true
      ...
      {
        question: "באיזו שנה הוקמו פלוגות הלילה המיוחדות?",
        answers: [
          {
            answer: "1938",
            type: true
      ...
      {
        question: "באיזו שנה פוצץ מלון המלך דוד?",
        answers: [
          {
            answer: "1946",
            type: true
      ...
      {
        question: "בין אילו צבאות חולק המזרח התיכון בתום מלחמת העולם הראשונה?'",
        answers: [
          {
            answer: "הצבא הבריטי לצבא הצרפתי",
            type: true
          },
          {
            answer: "הצבא הבריטי לצבא הטורקי",
            type: false
          },
          {
            answer: "הצבא הבריטי לצבא הגרמני",
            type: false
          },
          {
            answer: "הצבא הצרפתי לצבא הטורקי",
            type: false
          }
        ]
      },
      {
        question:
          "בעקבות טבח שאירע במאורעות תרפ''ט, באיזו עיר חדל להתקיים היישוב היהודי חדל להתקיים?",
        answers: [
          {
            answer: "חברון",
            type: true
      ...
      {
        question: "היכן החלו התקיפות של הכנופיות הערביות במאורעות תרפ''א?",
        answers: [
          {
            answer: "יפו, תל אביב וכמה מושבות נוספות",
            type: true
          },
          {
            answer: "חיפה, נהריה והקיבוצים בסביבה",
            type: false
          },
          {
            answer: "באר שבע, נתיבות והישובים באיזור",
            type: false
          },
          {
            answer: "חיפה ותל אביב -הערים המרכזיות",
            type: false
          }
        ]
      },
      {
        question: "היכן היה מוקד גל האלימות שפרץ במאי 1921 (מאורעות תרפ''א)?",
        answers: [
          {
            answer: "יפו, תל אביב וכמה מושבות נוספות",
            type: true
          ...
          {
            answer: "באר שבע, נתיבות והישובים באזור",
            type: false
          },
          {
            answer: "חיפה ותל אביב -הערים המרכזיות",
      ...
      {
        question: "הפלמ''ח הוקם עקב איום של צבא ____לארץ ישראל?",
        answers: [
          {
            answer: "גרמניה",
            type: true
      ...
      {
        question: "כיצד גילו הטורקים על ארגון ניל''י?",
        answers: [
          {
            answer: "בעקבות תפיסת יונת דואר ששלחו אנשי הארגון אל הבריטים",
            type: true
          },
          {
            answer: "כאשר באחת מהפגישות החשאיות התחזה חייל טורקי לשוטר בריטי",
            type: false
          },
          {
            answer:
              "על ידי וידויי של שבוי בריטי שלאחר עינויים גילה את סוד הארגון",
            type: false
          },
          {
            answer: "כאשר תפסו הטורקים את אחד מחברי הארגון בזמן פעולה נגדם",
            type: false
          }
        ]
      },
      {
        question: "כיצד כונתה האינתיפאדה השנייה בצה''ל?",
        answers: [
          {
            answer: "אירועי גאות ושפל",
            type: true
          },
          {
            answer: "אירועי השנה האפורה",
            type: false
          },
          {
            answer: "אירועי חבלה",
      ...
      {
        question: "כיצד נקרא ארגון השמירה הראשון?",
        answers: [
          {
            answer: "בר-גיורא",
            type: true
      ...
      {
        question: "כיצד נקרא המרד שפרץ באפריל 1936 של הערבים נגד שלטון המנדט?",
        answers: [
          {
            answer: "המרד הערבי הגדול",
            type: true
          },
          {
            answer: "המרד הערבי העליון",
            type: false
          },
          {
            answer: "מאורעות תר''פ",
      ...
      {
        question: "כיצד נקראו מצודות המשטרה שנבנו בכל הארץ?",
        answers: [
          {
            answer: "מצודות טיגרט",
            type: true
          ...
          {
            answer: "מצודות אבטחה והגנה",
            type: false
          }
        ]
      },
      {
        question: "לכמה חלקים ניתן לחלק את מלחמת העצמאות?",
        answers: [
          {
            answer: "שני חלקים",
            type: true
      ...
      {
        question: "למי סייעו חברי ארגון ניל''י?",
        answers: [
          {
            answer: "בריטים",
            type: true
      ...
      {
        question: "לשם איזו מטרה הוקם ארגון ניל''י?",
        answers: [
          {
            answer: "לסייע לבריטים לכבוש את הארץ מיידי הטורקים",
            type: true
          },
          {
            answer: "ליטול את אחריות השמירה והביטחון על הישוב היהודי",
            type: false
          },
          {
            answer: "ללמד את העולים החדשים לבצע פעולות ריגול נגד הבריטים",
            type: false
          },
          {
            answer: "לסייע לטורקים לכבוש את הארץ מיידי הבריטים ",
            type: false
          }
        ]
      },
      {
        question: "לשם איזו מטרה הצטרף יוסף טרומפלדור לאנשי תל-חי?",
        answers: [
          {
            answer: "לארגן את השמירה במקום",
            type: true
          },
          {
            answer: "לבנות את היישוב החדש",
            type: false
          },
          {
            answer: "לבנות צבא קטן שיגן על תל-חי",
            type: false
          },
          {
            answer: "לפקד על היחידה שמוצבת בתל-חי",
            type: false
          }
        ]
      },
      {
        question: "מה הוחלט ב''ועדת פיל''?",
        answers: [
          {
            answer: "לחלק את הארץ לשתי מדינות",
            type: true
          },
          {
            answer: "לחלק את השלטון בארץ לבריטי ויהודי",
            type: false
          },
          {
            answer: "לרכז את השלטון אצל הבריטים",
            type: false
          },
          {
            answer: "לרכז את השלטון אצל היהודים",
            type: false
          }
        ]
      },
      {
        question: "מה החליטה ממשלת ישראל בדצמבר 2008?",
        answers: [
          {
            answer: "לצאת למבצע עופרת יצוקה",
            type: true
          },
          {
            answer: "לצאת מגבול לבנון",
            type: false
          },
          {
            answer: "להיכנס לשטחי לבנון",
            type: false
          },
          {
            answer: "לצאת משטחי עזה",
            type: false
          }
        ]
      },
      {
        question: "מה היו הסכמי רודוס?",
        answers: [
          {
            answer: "ההסכמים אחרי מלחמת העצמאות",
            type: true
          },
          {
            answer: "ההסכמים אחרי מלחמת העולם הראשונה",
            type: false
          },
          {
            answer: "ההסכמים אחרי מלחמת העולם השנייה",
            type: false
          },
          {
            answer: "ההסכמים אחרי מלחמת היום כיפור",
            type: false
          }
        ]
      },
      {
        question: "מה הייתה החטיבה היהודית הלוחמת (חי''ל)?",
        answers: [
          {
            answer:
              "הבריגדה היהודית, לחמה בחזית האיטלקית, נתפסה כמי שמייצגת באופן רשמי את העם היהודי",
            type: true
          },
          {
            answer:
              "המרי העברי, איחוד בין האצ''ל הלח''י וההגנה שפעל ע''מ להפיל את המשטר הבריטי",
            type: false
          },
          {
            answer:
              "גוף אזרחי בו היו חברים שלושה נציגים של הסתדרות העובדים ושלושה נציגים נוספים של ‘‘המחנה האזרחי’‘ שפיקח על הישוב היהודי",
            type: false
          },
          {
            answer:
              "ארגון אשר הוקם כדי ליטול את האחריות על השמירה והביטחון של היישוב היהודי בארץ ישראל מידי הערבים והבריטים",
            type: false
          }
        ]
      },
      {
        question: "מה הייתה המטרה המרכזית במבצע נחשון?",
        answers: [
          {
            answer: "לפרוץ את הדרך לירושלים",
            type: true
          },
          {
            answer: "לשחרר את נחשון ווקסמן",
            type: false
          },
          {
            answer: "לפרוץ את הדרך לת''א",
            type: false
          },
          {
            answer: "לפרוץ את הדרך לחיפה",
            type: false
          }
        ]
      },
      {
        question: "מה הייתה פעולת ''כראמה''?",
        answers: [
          {
            answer:
              "פעולה בה כוחות צה''ל השתלטו על עיר ירדנית (בה פעלה מפקדת הפת''ח)במסגרת מלחמת ההתשה",
            type: true
          },
          {
            answer:
              "פעולה בה כוחות צה''ל השתלטו על האי גרין (בו מתחם מצרי מבוצר) במסגרת מלחמת העצמאות",
            type: false
          },
          {
            answer:
              "פעולה בה כוחות צה''ל תקפו שדות תעופה ברחבי מצריים והשמידו אותם תוך שעות אחדות במסגרת מלחמת ההתשה",
            type: false
          },
          {
            answer:
              "פעולה בה כוחות צה''ל הפילו מטוסים סורים בדרום הכינרת במסגרת מלחמת ששת הימים",
            type: false
          }
        ]
      },
      {
        question: "מה נקבע לאחר הסכמי שביתת הנשק בתום מלחמת העצמאות?",
        answers: [
          {
            answer: "גבולות ברורים בין ישראל לשכנותיה",
            type: true
          },
          {
            answer: "גבולות זמניים בין ישראל לשכנותיה",
            type: false
          },
          {
            answer: "הפסקת פעולות הטרור נגד ישראל",
            type: false
          },
          {
            answer: "הסכם שלום בין היהודים לערביי ישראל",
            type: false
          }
        ]
      },
      {
        question: "מהו ''גדוד נהגי הפרדות''?",
        answers: [
          {
            answer: "גדוד תובלה שנועד לסייע לבריטים",
            type: true
          },
          {
            answer: "חבורה של חקלאים העוסקים במיוחד בגידול חומרים",
            type: false
          },
          {
            answer: "גדוד חדש שלימים הפך ליחידה 101",
            type: false
          },
          {
            answer: "גדוד שהורכב מחיילים בריטים שעזרו לארגונים יהודים",
            type: false
          }
        ]
      },
      {
        question: "מהו ארגון בר גיורא?",
        answers: [
          {
            answer: "ארגון השמירה הראשון בארץ ישראל",
            type: true
          },
          {
            answer: "ארגון סודי שהמשיך את המורשת של ניל''י",
            type: false
          },
          {
            answer: "ארגון שהוקם בימי העלייה הראשונה",
            type: false
          },
          {
            answer: "ארגון שהוקם כדי ליטול את אחריות השמירה מהבריטים",
            type: false
          }
        ]
      },
      {
        question: "מהו כביש הצפון?'",
        answers: [
          {
            answer: "כביש ביטחון על הגבול בין ישראל ללבנון",
            type: true
          },
          {
            answer: "כביש ביטחון על הגבול בין ישראל לסוריה",
            type: false
          },
          {
            answer: "כביש שמתחיל בדרום ומוביל לצפון",
            type: false
          },
          {
            answer: "כביש שמגיע מתל אביב לגבול לבנון",
            type: false
          }
        ]
      },
      ...
      {
        question: "מהו שמה הנוסף של החטיבה היהודית הלוחמת?",
        answers: [
          {
            answer: "הבריגדה היהודית",
            type: true
          },
          {
            answer: "הגדוד היהודי",
          ...
          {
            answer: "פלוגות השדה הלוחמות",
            type: false
          }
        ]
      },
      {
        question: "מהו שמה השני של מלחמת סיני?",
        answers: [
          {
            answer: "מבצע קדש",
            type: true
      ...
      {
        question: "מהו שמו השני של ''מבצע יונתן''?",
        answers: [
          {
            answer: "כדור רעם",
            type: true
      ...
      {
        question: "מהן מצודות טיגרט?",
        answers: [
          {
            answer: "מצודות משטרה שנבנו במטרה להגביר את השליטה והביטחון",
            type: true
          },
          {
            answer: "מצודות שנבנו כחלק מתוכנית חומה ומגדל",
            type: false
          },
          {
            answer: "מצודות שנבנו בשביל צה''ל",
            type: false
          },
          {
            answer: "מצודות שנבנו כחלק מתוכנית הקמת פלוגות לילה מיוחדות",
            type: false
          }
        ]
      },
      {
        question: "מחיבורם של אילו שני ארגונים הוקם ארגון האצ''ל?",
        answers: [
          {
            answer: "ההגנה וארגון ב'",
            type: true
          },
          {
            answer: "הפלמ''ח ולח''י",
      ...
      {
        question: "מי היא היחידה שקיבלה על עצמה את ביצוע ''מבצע יונתן''?",
        answers: [
          {
            answer: "סיירת מטכ''ל",
            type: true
      ...
      {
        question: "מי היה הוגה רעיון ה''הגדודים העבריים''?",
        answers: [
          {
            answer: "זאב ז'בוטינסקי",
            type: true
      ...
      {
        question: "מי היה חאג' אמין אל חוסייני?",
        answers: [
          {
            answer: "מנהיג דתי ופוליטי של ערביי ארץ ישראל",
            type: true
          },
          {
            answer: ". מנהיג דתי של ערביי צרפת",
            type: false
          },
          {
            answer: "מנהיג דתי ופוליטי של ערביי בריטניה",
            type: false
          },
          {
            answer: "מנהיג פוליטי של ערביי טורקיה",
            type: false
          }
        ]
      },
      {
        question: "מי היה שר הביטחון בזמן מלחמת ההתשה?",
        answers: [
          {
            answer: "משה דיין",
            type: true
      ...
      {
        question: "מי היו הנוטרים?",
        answers: [
          {
            answer: "שוטרים יהודים שגויסו על ידי הבריטים",
            type: true
          },
          {
            answer: "שוטרים בריטים שפעלו נגד היהודים",
            type: false
          },
          {
            answer: "שוטרים סמויים בצבא הבריטי",
            type: false
          },
          {
            answer: "שוטרים בריטים שפעלו ביחד עם ארגונים יהודים",
            type: false
          }
        ]
      },
      {
        question: "מי הם הצנחנים הארץ-ישראלים?",
        answers: [
          {
            answer: "צנחנים שהוכשרו ע''י בריטים לצניחה מעבר לקווי אויב",
            type: true
          },
          {
            answer:
              "צנחנים שהוכשרו ע''י החטיבה היהודית הלוחמת לצניחה מעבר לקווי אויב",
            type: false
          },
          {
            answer: "צנחנים שהוכשרו ע''י המחתרות לריגול אחרי הבריטים",
            type: false
          },
          {
            answer: "צנחנים שהוכשרו ע''י הפלמ''ח ללחימה למקרה שתפרוץ מלחמה",
            type: false
          }
        ]
      },
      {
        question: "מי הקים את פלוגות הלילה המיוחדות?",
        answers: [
          {
            answer: "צ'ארלס וינגייט",
            type: true
          },
          {
            answer: "ברל כצנלסון",
      ...
      {
        question: "מי כהן כרמטכ''ל בזמן מלחמת לבנון השנייה?",
        answers: [
          {
            answer: "דן חלוץ",
            type: true
      ...
      {
        question: "מי כיהן בתור ראש ממשלה בזמן מלחמת לבנון השנייה?",
        answers: [
          {
            answer: "אהוד אולמרט",
            type: true
      ...
      {
        question: "מי כיהן כרמטכ''ל במהלך מלחמת שלום הגליל?",
        answers: [
          {
            answer: "רפאל איתן",
            type: true
      ...
      {
        question: "מי כיהן ראש ממשלה במהלך מלחמת יום הכיפורים?",
        answers: [
          {
            answer: "גולדה מאיר",
            type: true
      ...
      {
        question: "מעצם תפקידה של ''ועדת פיל'', מה היה עליה לבדוק?'",
        answers: [
          {
            answer:
              "הסיבות לפרוץ מאורעות תרצ''ח-תרצ''ט ולהציע פתרון לסכסוך היהודי-ערבי",
            type: true
          },
          {
            answer: "בעיית הסכסוך הבריטי- צרפתי",
            type: false
          },
          {
            answer:
              "הסיבות לסכסוך בין הבריטים ליהודים ולהציע פתרונות למניעת הסכסוך",
            type: false
          },
          {
            answer: "הגורם לפרוץ המרד הערבי הגדול",
            type: false
          }
        ]
      },
      {
        question: "מתי הוקם ארגון ''השומר''?",
        answers: [
          {
            answer: "1909",
            type: true
      ...
      {
        question: "מתי הוקם צה''ל?",
        answers: [
          {
            answer: "ב26 במאי 1948",
            type: true
          },
          {
            answer: "ב26 ביוני 1947",
            type: false
          },
          {
            answer: "ב26 באוגוסט 1948",
            type: false
          },
          {
            answer: "ב26 באפריל 1948",
            type: false
          }
        ]
      },
      ...
      {
        question: "מתי החל האצ''ל  לפעול נגד מטרות בריטיות?",
        answers: [
          {
            answer: "לאחר פרסום הספר הלבן השלישי",
            type: true
          },
          {
            answer: "כשהחלו פעולות טרור של היישוב הערבי נגד היישוב היהודי",
            type: false
          },
          {
            answer: "עם פרסום גזרות עלייה נוספות על פליטי השואה",
            type: false
          },
          {
            answer: "כשהחל ריב בין אחד מחברי הארגון עם שוטר בריטי",
            type: false
          }
        ]
      },
      ...
      {
        question: "מתי נפתחה המלחמה נגד הישוב היהודי לביטול תוכנית החלוקה?",
        answers: [
          {
            answer: "1947",
            type: true
      ...
      {
        question: "נגד מי פתחה ישראל בחזית במלחמת סיני באוקטובר 1956?",
        answers: [
          {
            answer: "מצריים",
            type: true
      ...
      {
        question: "ע''י מי הוקמו הגדודים העבריים?",
        answers: [
          {
            answer: "יוסף טרומפלדור וזאב ז'בוטינסקי",
            type: true
          },
          {
            answer: "יוסף טרומפלדור וברל כצנלסון",
            type: false
          },
          {
            answer: "טרומפלדור ויוסף חיים ברנר",
            type: false
          },
          {
            answer: "צ'ארלס וינגייט ויוסף טרומפלדור",
            type: false
          }
        ]
      },
      {
        question: "נוסח ה''יזכור'' בו נעשה שימוש בישראל מבוסס על",
        answers: [
          {
            answer: "הספד שחיבר ברל כצנלסון על הרוגי מאורעות תל חי",
            type: true
          },
          {
            answer: "הספד שחיבר הראשי בטו ורשה מנחם זמבה בהיגעם למחנה טרבלינקה",
            type: false
          },
          {
            answer: "נוסח תפילת הרב הראשי לקהילת בריה’‘מ לאחר פוגרום קישינב",
            type: false
          },
          {
            answer: "הנוסח שנכתב על ידי הרב מאיר ישראל לאו ליום הזיכרון לשואה",
            type: false
          }
        ]
      },
      {
        question: "על איזו אזור השתלט צה''ל בסיום מלחמת סיני?",
        answers: [
          {
            answer: "חצי האי סיני ורצועת עזה",
            type: true
          },
          {
            answer: "רמת הגולן והחרמון הסורי",
            type: false
          },
          {
            answer: "חצי האי סיני בלבד",
            type: false
          },
          {
            answer: "חצי האי סיני ורמת הגולן",
            type: false
          }
        ]
      },
      {
        question: "על ידי מי הופעלו הצנחנים הארצישראלים?",
        answers: [
          {
            answer: "הסוכנות היהודית",
            type: true
          },
          {
            answer: "ההגנה",
      ...
      {
        question:
          "תחת איזו שליטה היה צריך להיות נתון אזור אצבע הגליל לפי הסכמי ''סייקס-פיקו''?",
        answers: [
          {
            answer: "צרפתית",
            type: true
